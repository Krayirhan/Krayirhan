...
**📱 Mobil Geliştirme**
Kotlin ile native Android, React Native/Expo ile cross-platform, Unity/C# ile oyun geliştirme ve Flutter/Dart ile hızlı prototipleme.

**🧠 Yapay Zeka & Veri Bilimi**
Tıbbi görüntü segmentasyonundan (U-Net, %86,91 Dice skoru) müşteri kaybı tahminine, endüstriyel kusur tespitine kadar uçtan uca ML pipeline'ları kuruyorum — FastAPI ile production'a alıyorum.

</td>
<td width="50%" valign="top">

**💻 Web & SaaS Ürünleri**
TypeScript/React tabanlı SaaS ürünleri tasarlıyor, dokümante ediyor ve geliştiriyorum — sıfırdan MVP'ye.

**⚙️ Backend & Sistem Tasarımı**
Java/Jakarta EE ile kurumsal sistemler, Oracle DB entegrasyonları, özel exception handling ve MVC mimarisi.
